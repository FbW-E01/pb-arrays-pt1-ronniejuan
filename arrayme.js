...
//console.log(euroCities);
 ...
 const lasteuroCitiesEntered = euroCities.pop()
 console.log(lasteuroCitiesEntered);
 console.log(euroCities);
...
const asianCities = ["Beijing", "Tokyio", "Mumbai", "Vietiane", "Hong-Kong","Ulan Bator"];
...
const family = ["Josefa", "Rose", "Alan", "Denise"]

// 2. Make an array of your parents' names.

const parents = ["Rose", "Daniel"]
